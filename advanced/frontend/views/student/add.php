...
<div class="right">
    <div class="search-box">
        <form action="?r=student/add_do" method="post">
            <ul>
                <li>
                    <span>请输入字段名称：</span>
                ...
                <li>
                    <span>请输入字段默认值：</span>
                    <input class="filed-name" name="moren" type="text">
                </li>
                <li>
                    <span>请选择字段类型：</span>
                    <select name="ziduan" >
                ...
                <li>
                    <span>请填写字段选项：</span>
                    <input type="text" class="filed-name" name="x_one" placeholder="选项1">
                    <input type="text" class="filed-name" name="x_two" placeholder="选项2">
                </li>
                <li>
                    <span>是否必填：</span>
                    <input type="checkbox" name="status" value="1">必填
                </li>
                <li>
                    <span>请选择验证规则：</span>
                    <select name="yz" >
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input class="length" type="text" name="l_one" placeholder="请输入最小长度">
                    ~
                    <input class="length" type="text" name="l_two" placeholder="请输入最大长度">
                </li>
                <li>
